    ...
    return (
        <article className='w-full flex items-center justify-between rounded-3xl border border-solid 
            ...
            <div className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2.5rem] bg-dark 
                rounded-br-3xl dark:bg-light xs:-right-2 sm:h-[101.5%] xs:w-full xs:rounded-[1.5rem]"/>
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
                ...
                <div className='mt-2 flex items-center'>
                    <Link href={github} target='_blank' className='w-10'>
                        <GithubIcon className='dark:bg-light rounded-full'></GithubIcon>
                    </Link>
...
const Projects = () => {
  return (
    <>
        <Head>
            <title>JFFC | Projects page</title>
            <meta name='description' content='Javier Flores Projects'/>
        </Head>
        <TransitionEffect/>
            ...
            <Layout className='pt-16'>
                ...
                <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0 sm:gap-y-12'>
                    <div className='col-span-12'>
                        <FeaturedProject title='Crypto Screener Application' summary='A feature-rich Crypto Screener App using React, Tailwind CSS, Context API, React Router and Recharts. 
                            It shows detail regarding almost all the cryptocurrency. You can easily convert the price in your 
                            local currency.' link='/' type='Featured Project' img={project1Image} github='/'></FeaturedProject>
                    </div>
