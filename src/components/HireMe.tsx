...
const HireMe = () => {
  return (
    <div className='fixed left-4 bottom-4 flex items-center justify-center md:absolute 
        overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto sm:right-0'>
